...
function makepass16() { perl -MCrypt::XkcdPassword -E'say Crypt::XkcdPassword->new(words=>"EN")->make_password(16)'; }

function makepass8() { perl -MCrypt::XkcdPassword -E'say Crypt::XkcdPassword->new(words=>"EN")->make_password(8)'; }

function makepass4() { perl -MCrypt::XkcdPassword -E'say Crypt::XkcdPassword->new(words=>"EN")->make_password(4)'; }

. ~/.git_term
. ~/.aliases
eval $(keychain --eval --agents ssh -Q /home/john/.ssh/id_rsa)
